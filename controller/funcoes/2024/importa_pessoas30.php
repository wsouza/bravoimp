...
function profissionais30($linha)
{
    ...
    if (!empty($aCampos[45])) { // se professor
        ...
        $arrayVariaveis = array(
            'escolaridade' => campoCorrigir($aCampos[46]),
            'tipo_ensinomedio' => campoCorrigir($aCampos[47]),
            'tbpessoa_id' => $idPessoa
        );
        ...
        if (!empty(trim($aCampos[47]))) { //se possuir ensino superios
            $arrayProSuperiores1 = array(
                ...
                'tbsuperioresocupacoe_id2020' => campoCorrigir($aCampos[48]),
                'ano_inicio' => NULL,
                'ano_fim' => campoCorrigir($aCampos[49]),
                'tipo_instituicao' => NULL,
                'tbie_id' => campoCorrigir($aCampos[50]),
                'tbpessoa_id' => $idPessoa
            );
        ...
        if (!empty(trim($aCampos[50]))) {
            $arrayProSuperiores2 = array(
                ...
                'com_pedagogico' => NULL,
                'tbsuperioresocupacoe_id' => NULL,
                'tbsuperioresocupacoe_id2020' => campoCorrigir($aCampos[51]),
                'ano_inicio' => NULL,
                'ano_fim' => campoCorrigir($aCampos[52]),
                'tipo_instituicao' => NULL,
                'tbie_id' => campoCorrigir($aCampos[53]),
                'tbpessoa_id' => $idPessoa
            );
        ...
        if (!empty(trim($aCampos[53]))) {
            ...
            $arrayProSuperiores3 = array(
                ...
                'com_pedagogico' => NULL,
                'tbsuperioresocupacoe_id' => NULL,
                'tbsuperioresocupacoe_id2020' => campoCorrigir($aCampos[54]),
                'ano_inicio' => NULL,
                'ano_fim' => campoCorrigir($aCampos[55]),
                'tipo_instituicao' => NULL,
                'tbie_id' => campoCorrigir($aCampos[56]),
                'tbpessoa_id' => $idPessoa
            );
        ...
        $arrayProPos = array(
            'tipo1' => campoCorrigir($aCampos[60]),
            'area1' => campoCorrigir($aCampos[61]),
            'ano1' => campoCorrigir($aCampos[62]),

            'tipo2' => campoCorrigir($aCampos[63]),
            'area2' => campoCorrigir($aCampos[64]),
            'ano2' => campoCorrigir($aCampos[65]),

            'tipo3' => campoCorrigir($aCampos[66]),
            'area3' => campoCorrigir($aCampos[67]),
            'ano3' => campoCorrigir($aCampos[68]),

            'tipo4' => campoCorrigir($aCampos[69]),
            'area4' => campoCorrigir($aCampos[70]),
            'ano4' => campoCorrigir($aCampos[71]),

            'tipo5' => campoCorrigir($aCampos[72]),
            'area5' => campoCorrigir($aCampos[73]),
            'ano5' => campoCorrigir($aCampos[74]),

            'tipo6' => campoCorrigir($aCampos[75]),
            'area6' => campoCorrigir($aCampos[76]),
            'ano6' => campoCorrigir($aCampos[77]),
        ...
        if(!empty(campoCorrigir($aCampos[60]))){
        ...
        $arrayComplementacao = array(
            'opcao_1' => campoCorrigir($aCampos[57]),
            'opcao_2' => campoCorrigir($aCampos[58]),
            'opcao_3' => campoCorrigir($aCampos[59]),
            'tbpessoa_id' => $idPessoa
        );
        ...
        $arrayProOutrosCursosca = array(
            'opcao_1' => campoCorrigir($aCampos[79]),
            'opcao_2' => campoCorrigir($aCampos[80]),
            'opcao_3' => campoCorrigir($aCampos[81]),
            'opcao_4' => campoCorrigir($aCampos[82]),
            'opcao_5' => campoCorrigir($aCampos[83]),
            'opcao_6' => campoCorrigir($aCampos[84]),
            'opcao_7' => campoCorrigir($aCampos[85]),
            'opcao_8' => campoCorrigir($aCampos[86]),
            'opcao_9' => campoCorrigir($aCampos[87]),
            'opcao_10' => campoCorrigir($aCampos[88]),
            'opcao_11' => campoCorrigir($aCampos[89]),
            'opcao_12' => campoCorrigir($aCampos[90]),
            'opcao_13' => campoCorrigir($aCampos[91]),
            'opcao_14' => campoCorrigir($aCampos[92]),
            'area_conhecimento1' => campoCorrigir($aCampos[93]),
            'opcao_15' => campoCorrigir($aCampos[94]),
            'tbpessoa_id' => $idPessoa
        );
